...
Route::middleware(['user'])->group(function () {
    ...
    Route::get('/barang', [BarangController::class, 'index'])->name('barang.dftBarang');
    Route::delete('/hpsBarang/{id}', [BarangController::class, 'destroy'])->name('hpsBarang');
    ...
    Route::get('/edtBarangMasuk/{id}', [BarangMasukController::class, 'edit']);
    //Route::get('/listedt/{id}', [BarangMasukController::class, 'get_edtbarang']);
    Route::post('/edtBarangMasuk/{id}', [BarangMasukController::class, 'update']);
    Route::delete('/hpsBarangMasuk/{id}', [BarangMasukController::class, 'destroy'])->name('hpsBarangMasuk');
    ...
    //Route::get('/barang-keluar/edit/{id_barang_keluar}', [BarangKeluarController::class, 'edit'])->name('barang_keluar.edit');
    //Route::get('/edtbarang-keluar', [BarangKeluarController::class, 'edit']);
    Route::get('/edtBarangKeluar/{id}', [BarangKeluarController::class, 'edit']);
    Route::post('/edtBarangKeluar/{id}', [BarangKeluarController::class, 'update']);
    //Route::delete('/hpsBarangKeluar/{id}', [BarangKeluarController::class, 'destroy']);
    Route::delete('/hpsBarangKeluar/{id}', [BarangKeluarController::class, 'destroy'])->name('hpsBarangKeluar');
